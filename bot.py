...
@dp.message_handler(lambda m: m.text in ["📞 Связаться с нами", "📞 Biz bilan bog‘lanish"])
async def contacts(message: types.Message):
    ...
    kb.add(
        types.InlineKeyboardButton("📩 Telegram", url="https://t.me/tymapucclo"),
        types.InlineKeyboardButton("💌 Instagram", url="https://instagram.com/tymapuc.clo")
    )
